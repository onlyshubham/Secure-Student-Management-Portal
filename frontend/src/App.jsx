      ...
      <main>
        ...
        <section className="security-section">
          <div>
            ...
            <h3>Designed around secure access and responsible data handling.</h3>
          </div>

          <div className="security-points">
            <div>
              <strong>Authentication</strong>
              <p>Users must verify their identity before accessing the portal.</p>
            </div>

            <div>
              <strong>Access Control</strong>
              <p>Different users receive access based on their assigned role.</p>
            </div>

            <div>
              <strong>Security Logging</strong>
              <p>Important security-related activity can be recorded and reviewed.</p>
            </div>
          </div>
        </section>
      </main>
